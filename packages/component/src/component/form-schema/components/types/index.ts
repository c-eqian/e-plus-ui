...
export interface ComponentProps {
  ...
  'radio-group': ExtractPropTypes<
    typeof import('element-plus/es')['ElRadioGroup']
  >;
  'checkbox-group': ExtractPropTypes<
    typeof import('element-plus/es')['ElCheckboxGroup']
  >;
  input: ExtractPropTypes<typeof import('element-plus/es')['ElInput']>;
  autocomplete: ExtractPropTypes<
    typeof import('element-plus/es')['ElAutocomplete']
  >;
  'date-picker': ExtractPropTypes<
    typeof import('element-plus/es')['ElDatePicker']
  >;
  'time-picker': ExtractPropTypes<
    typeof import('element-plus/es')['ElTimePicker']
  >;
  'time-select': ExtractPropTypes<
    typeof import('element-plus/es')['ElTimeSelect']
  >;
