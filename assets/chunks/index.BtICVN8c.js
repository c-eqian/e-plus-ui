import{d as n,r as t,ah as r,o as c,H as l,I as p,a as m,O as u}from"./framework.CH__HHFe.js";const _={class:"item",style:{padding:"15px"}},g=n({__name:"index",setup(f){const a=t([]),s=t([]);for(let e=0;e<1e5;e++)a.value.push(e),e%2===0?s.value.push(`${e+1}.提示用户确认其已经触发的动作，并询问是否进行此操作时会用到此对话框。
